...
class TestDemoClass:
    ...
    def get_data():
        # get data from database, excel, csv, etc.
        excel_file = openpyxl.load_workbook("data/invalid_login.xlsx")  # open excel file
        selected_sheet = excel_file["Sheet1"]  # get active sheet
        total_rows = selected_sheet.max_row  # get total rows
    ...
    def test_invalid_login(self, username, password):
        ...
        assert error_message.text == globalConstants.ERROR_MESSAGE
